...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof tech.digiwise.tahadi.service.EmailAlreadyUsedException ||
            ex instanceof tech.digiwise.tahadi.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof tech.digiwise.tahadi.service.InvalidPasswordException
